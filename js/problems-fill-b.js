(() => {
  ...
  window.PROBLEMS = window.PROBLEMS.concat([
    entry({
      ...
      figure: { kind: "square", title: "The lower triangle", caption: "The event X+Y<1 is half the unit square.", heading: "Unit square", pred: (x, y) => x + y < 1, note: "Area 1/2. Gold is the event." }
    }),
    entry({
      ...
      figure: { kind: "square", title: "Northeast quarter", caption: "X>1/2 and Y>1/2 is a square of side 1/2, area 1/4.", heading: "Independence is area", pred: (x, y) => x > 0.5 && y > 0.5, note: "P = (1/2)×(1/2) = 1/4." }
    }),
    entry({
      ...
      figure: { kind: "stick", title: "One uniform cut", caption: "The longer piece exceeds 2/3 iff the cut is in [0,1/3] or [2/3,1], probability 2/3.", heading: "Longer than 2/3", nCuts: 1, marks: [1 / 3, 2 / 3], note: "Not the two-break triangle problem." }
    }),
    entry({
      ...
      figure: { kind: "square", title: "Two corner triangles", caption: "|U-V|>1/2 is two right triangles of legs 1/2, total area 1/4.", heading: "Far points", pred: (x, y) => Math.abs(x - y) > 0.5, xLabel: "U", yLabel: "V", note: "Area 1/4, not 1/2." }
    }),
    entry({
      ...
      figure: { kind: "stick", title: "Two uniform points", caption: "The two points split the stick into three exchangeable spacings. Each has mean 1/3, so E|U-V|=1/3.", heading: "E|U-V|=1/3", nCuts: 2, note: "Not the broken-stick triangle. That needs all three lengths < 1/2." }
    }),
    entry({
      ...
      figure: { kind: "circle", title: "Disk in the square", caption: "Square area 4, disk area π, so the hit probability is π/4.", heading: "Monte Carlo for π", interior: true, square: true, note: "Gold inside the disk, blue outside. P = π/4." }
    }),
    entry({
      ...
      figure: { kind: "circle", title: "Radius is not uniform", caption: "Area element is 2r dr. Mass sits near the rim, so E[R]=2/3, not 1/2.", heading: "Uniform in the disk", interior: true, showCenter: true, note: "f_R(r)=2r on [0,1]." }
    }),
    entry({
      ...
      figure: { kind: "stick", title: "Three exchangeable pieces", caption: "Two cuts make three spacings. Each has mean 1/3, including the leftmost.", heading: "Left piece A", nCuts: 2, note: "A = U_(1) ~ Beta(1,2)." }
    }),
    entry({
      ...
      figure: { kind: "circle", title: "Random endpoints", caption: "Fix one point. The chord beats the triangle side iff the other point sits on an arc of length 2π/3, so P=1/3.", heading: "Bertrand chord", nPts: 2, chord: true, note: "Name the measure. Other models give 1/2 or 1/4." }
    }),
    entry({
      ...
      figure: { kind: "circle", title: "Does the triangle cover the center?", caption: "The center is inside iff no semicircle contains all three points. For n=3 that probability is 1/4.", heading: "Three points on a circle", nPts: 3, triangle: true, showCenter: true }
    }),
    entry({
      ...
      figure: { kind: "square", title: "Three random points", caption: "The mean area is 11/144. A 'typical' 1/2 × 1/2 triangle is the usual overestimate.", heading: "Random triangle in the square", n: 3, pred: () => false, triangle: true, note: "E[area]=11/144 ≈ 0.076." }
    }),
    entry({
      ...
      figure: { kind: "bars", title: "Every pair shakes once", caption: "A handshake is a 2-subset. C(10,2)=45.", heading: "Handshakes", items: [{ label: "people", value: 10 }, { label: "pairs", value: 45, gold: true }], note: "C(10,2)=45." }
    }),
    entry({
      ...
      figure: { kind: "coins", title: "In or out", caption: "Each of 8 elements is in or out. 2^8=256 subsets, including empty and full.", heading: "Power set", count: 8, bits: true, note: "8 independent bits, 256 subsets." }
    }),
    entry({
      ...
      figure: { kind: "perm", title: "5! arrows", caption: "A bijection is a permutation. 5!=120.", heading: "Bijections on 5 letters", n: 5 }
    }),
    entry({
      ...
      figure: { kind: "bars", title: "Even vs odd", caption: "For n>0 the power set splits equally. 2^{n-1} even subsets.", heading: "Even-sized subsets", items: [{ label: "even", value: 32, gold: true }, { label: "odd", value: 32 }], note: "n=6: 32 and 32." }
    }),
    entry({
      ...
      figure: { kind: "perm", title: "Each pair is inverted half the time", caption: "C(n,2) pairs, each inverted with probability 1/2. Mean n(n-1)/4.", heading: "Inversions", n: 8, note: "Linearity. No need to sum over permutations." }
    }),
    entry({
      ...
      figure: { kind: "dyck", title: "Matched parentheses", caption: "Dyck words of length 8. The count is C_4=14.", heading: "Catalan paths" }
    }),
    entry({
      ...
      figure: { kind: "starsBars", title: "Positive solutions of x1+...+x4=10", caption: "Set yi=xi-1. Then y1+...+y4=6. Count C(6+4-1,3)=84.", heading: "Stars and bars", stars: 6, bars: 3, example: ["*", "*", "|", "*", "*", "*", "|", "*", "|", "*"], note: "C(9,3)=84." }
    }),
    entry({
      ...
      figure: { kind: "lockers", title: "Squares stay open", caption: "Locker k is toggled once per divisor. Only squares have an odd number of divisors.", heading: "100 lockers" }
    }),
    entry({
      ...
      figure: { kind: "network", title: "Labeled trees", caption: "Cayley: n^{n-2} trees on n labeled vertices. For n=6, 6^4=1296.", heading: "A tree on 6 labels", nodes: [{ x: 200, y: 80, label: "1", gold: true }, { x: 360, y: 80, label: "2" }, { x: 520, y: 80, label: "3" }, { x: 200, y: 220, label: "4" }, { x: 360, y: 220, label: "5" }, { x: 520, y: 220, label: "6" }], edges: [[0, 4, ""], [4, 1, ""], [1, 2, ""], [4, 3, ""], [1, 5, ""]], note: "Prüfer codes are a bijection with [n]^{n-2}." }
    }),
    entry({
      ...
      figure: { kind: "seats", title: "Seat 1 and seat n are symmetric", caption: "The displacement chain hits seat 1 or seat n equally often. Last passenger gets their seat with probability 1/2.", heading: "Airplane seating" }
    }),
    entry({
      ...
      figure: { kind: "match", title: "Four unlabeled pairs", caption: "Order 8 people, pair adjacent, divide by 2^4 4!. That is 105.", heading: "Perfect matchings" }
    }),
    entry({
      ...
      figure: { kind: "perm", title: "132 pattern", caption: "Avoiders are counted by Catalan. For n=5, C_5=42.", heading: "132-avoiding permutations", n: 5, note: "A 132 is a low-high-middle triple." }
    })
  ]);
})();
